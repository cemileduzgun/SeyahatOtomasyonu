...
{
 public   class XmlReport:ReportBuilder
    {
        public XmlReport(ReportInfo reportInfo) : base(reportInfo)
        {
        ...
        {
            string format = string.Format("<h3>Ulaşım  Türü: {0}</h3>", this.reportInfo.ulasim.ulasim_tur);
